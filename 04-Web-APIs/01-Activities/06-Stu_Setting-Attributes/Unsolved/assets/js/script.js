...
// this attempt didnt work because changing the main wouldnt let me adjust the padding and margin

//var changep = document.querySelector("#main")
//changep.setAttribute("style", "font-size: 30px; color: blue; text-decoration: bold; ")
...
for (var i = 0; i < h4.length; i++){
    h4[i].setAttribute("style", "font-size: 30px; color: blue; text-decoration: bold; padding-left: 10px; margin: 0px;")
}